...
local DEFAULT_CONFIG = {
	...
	{ name = "Flag", amount = "all", class = "Misc", match = "contains", allowPartial = true, required = false },
	{ name = "Chest", amount = "all", class = "Misc", match = "contains", allowPartial = true, required = false },
	{ name = "Pack", amount = "all", class = "Lootbox", match = "contains", allowPartial = true, required = false },
	{ name = "Ticket", amount = "all", class = "Misc", match = "contains", allowPartial = true, required = false },
	...
	{ name = "Egg", amount = "all", class = "Lootbox", match = "contains", allowPartial = true, required = false },
        { name = "Comet", amount = "all", class = "Misc", match = "contains", allowPartial = true, required = false },
	{ name = "Sprinkler", amount = "all", class = "Misc", match = "contains", allowPartial = true, required = false },
	{ name = "Party Box", amount = "all", class = "Misc", match = "contains", allowPartial = true, required = false },
	{ name = "Coin Jar", amount = "all", class = "Misc", match = "contains", allowPartial = true, required = false },
	...
	{ name = "TNT", amount = "all", class = "Charm", match = "contains", allowPartial = true, required = false },
	{ name = "Diamonds", amount = "all", class = "Charm", match = "contains", allowPartial = true, required = false },
	{ name = "Glittering", amount = "all", class = "Charm", match = "contains", allowPartial = true, required = false },
	{ name = "Criticals", amount = "all", class = "Charm", match = "contains", allowPartial = true, required = false },
	{ name = "Agility", amount = "all", class = "Charm", match = "contains", allowPartial = true, required = false },
	{ name = "Coins", amount = "all", class = "Charm", match = "contains", allowPartial = true, required = false },
	{ name = "Bonus", amount = "all", class = "Charm", match = "contains", allowPartial = true, required = false },
	{ name = "Strength", amount = "all", class = "Charm", match = "contains", allowPartial = true, required = false },
	{ name = "Lightning", amount = "all", class = "Charm", match = "contains", allowPartial = true, required = false },
	{ name = "Charm Hammer", amount = "all", class = "Misc", match = "contains", allowPartial = true, required = false },
	{ name = "Charm Stone", amount = "all", class = "Misc", match = "contains", allowPartial = true, required = false },
	{ name = "Magic Shard", amount = "all", class = "Misc", match = "contains", allowPartial = true, required = false },
	{ name = "Bucket O' Magic", amount = "all", class = "Misc", match = "contains", allowPartial = true, required = false },
	{ name = "Mega Charm Chest", amount = "all", class = "Lootbox", match = "contains", allowPartial = true, required = false },
	{ name = "Insta Plant Capsule", amount = "all", class = "Misc", match = "contains", allowPartial = true, required = false },
	{ name = "Mega Charm Chest", amount = "all", class = "Lootbox", match = "contains", allowPartial = true, required = false },
	{ name = "Gift", amount = "all", class = "Seed", match = "contains", allowPartial = true, required = false },
	{ name = "Coin", amount = "all", class = "Seed", match = "contains", allowPartial = true, required = false },
